<template>
  <div class="container-lg py-5">
    ...
    <div class="card text-center shadow-4 pt-4">
      <div class="text-700 text-center d-block">
      <div class="text-900 font-bold text-5xl mb-3">Sistema de Gestión de Información de Personal</div>
      <div class="text-700 text-2xl mb-5">Bienvenido, Raúl López.</div>
    </div>
      <div class="mb-6 font-bold text-3xl">
        <span class="text-blue-600">¿Qué desea hacer hoy?</span>
      </div>
      <div class="grid">
        ...
        <div class="col-12 md:col-4 mb-4 px-5">
          ...
          <div class="text-900 text-xl mb-3 font-medium">Administrar departamentos</div>
        </div>
        <div class="col-12 md:col-4 mb-4 px-5">
          <span class="p-3 shadow-2 mb-3 inline-block surface-card" style="border-radius: 10px">
            <i class="pi pi-search-plus text-4xl text-blue-500"></i>
          </span>
