                ...
                <div class="card-body">
                    <div class="row ms-0 mx-0">
                        ...
                        <div class="col-md-4 my-2">
                            ...
                            <input v-model="data.rfc" type="text" placeholder="Introduzca su RFC" class="form-control"
                        ...
                        <div class="col-md-5 my-2">
                            ...
                            <input v-model="data.curp" type="text" placeholder="Introduzca su CURP" class="form-control"
                        ...
                        <div class="col-5 col-md-3 my-2">
                            <label for="inputNombre" class="form-label">Edad <abbr class="initialism"
                                    title="Se calcula a partir de la CURP"><i
                                        class="bi bi-question-circle-fill"></i></abbr></label>
                            <input type="text" placeholder="Sin calcular" class="form-control-plaintext" id="edad"
                                readonly />
                        </div>
                        ...
                        <div class="col-md-6 my-2">
                            <label for="personalDiscapacidad" class="form-label">Discapacidad<b
                                    class="text-danger">*</b></label>
                            <select v-model="data.discapacidad" class="form-select" id="personalDiscapacidad"
                                name="selectDiscapacidad" required>
                        ...
                        <div class="col-md-6 my-2">
                            ...
                            <label for="nivelAcademico" class="form-label">Nivel Académico<b
                                    class="text-danger">*</b></label>
                            <select v-model="data.nivelAcademico" class="form-select" id="nivelAcademico" name="selectNA"
                                required>
                                <option value="" selected hidden class="text-muted">...</option>
                        ...
                        <div class="col-md-6 my-2">
                            ...
                            <input v-model="data.correoInstitucional" type="email"
                                placeholder="Correo @itoaxaca/@oaxaca.tecnm" class="form-control" id="correo"
                                pattern=".+@.+\..+" />
                        ...
                        <div class="col-md-12 my-2">
                            ...
                            <input v-model="data.profesion" type="text" placeholder="Profesión" class="form-control"
                                id="profesion" />
                            <div class="invalid-feedback">Por favor introduzca la profesión.</div>
                        </div>
                        <!-- Input número de tarjeta -->
                        <div class="col-md-5 my-2">
                            <label for="inputNumeroTarjeta" class="form-label">Número de tarjeta<b
                                    class="text-danger">*</b></label>
                            <input v-model="data.numeroTarjeta" type="number" placeholder="Número de tarjeta"
                                class="form-control" id="tarjeta" />
                        ...
                        <div class="col-md-6 my-2">
                            ...
                            <label for="inputFechaIngreso" class="form-label">Fecha de ingreso<b
                                    class="text-danger">*</b></label>
